...
import CoachingHelp5 from "@/components/CoachingHelp5";
import Footer from "@/components/footer";
import HowItWorks from "@/components/howitworks";
import Investment from "@/components/investment";
import ReaclaimPower from "@/components/reclaim-power";
...
import WhoCoaching5 from "@/components/WhoConnection5";
import { motion } from "framer-motion";
import Image from "next/image";
import Discover5 from "@/components/Discover5";
...
export default function Breakuprecovery() {
  ...
  return (
    <main className="w-full bg-white overflow-hidden">
      ...
      >
        <Image
          src="/services/traumahealing.png"
          alt="Trauma Healing"
          fill
