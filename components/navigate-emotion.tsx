...
export default function NavigateEmotion() {
  return (
    <section className="w-full bg-[#3E5F46] py-6 sm:py-12 flex justify-center">
      ...
      >
        ...
        >
          Learn to Navigate Emotions With Strength, Clarity & Calm.
        </motion.h2>
        ...
        >
          <p>
            If you often feel emotionally drained, overwhelmed, reactive, or
            unable to manage your feelings, these sessions help you build
            resilience from within — so you can move through life with balance
            and inner stability.
          </p>
        </motion.div>
        ...
        >
          <Image
            src="/services/NavigateEmotion.png"
