          ...
          {services.map((s, i) => (
            <motion.div
              ...
              whileHover={{
                ...
                color: "white",
                boxShadow: "0 8px 35px rgba(236, 64, 122, 0.35)",
                transition: { duration: 0.35, ease: "easeOut" },
              }}
              className="relative p-7 bg-[#F8F8F8] border border-pink-100 rounded-3xl shadow-sm overflow-hidden transition-all"
            >
              {/* BACKGROUND VECTOR */}
              <Image
                src={s.bg}
              ...
              <button
                ...
                text-white bg-black hover:bg-pink-100 hover:text-pink-600
