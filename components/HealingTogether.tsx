  ...
  return (
    <section className="w-full bg-[#3E5F46] py-6 sm:py-12 flex justify-center">
      ...
      >
        ...
        >
        Create a Relationship Where You Feel Heard, Understood & Emotionally Safe.
        </motion.h2>
        ...
        >
          <p>
            Healthy communication is the foundation of every strong relationship. This program helps you break unhealthy patterns, express your needs clearly, and listen without reacting — so both of you feel emotionally connected again.
          </p>
