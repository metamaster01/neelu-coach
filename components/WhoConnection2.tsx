      ...
      >
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-5 text-black text-[15px] leading-relaxed pl-1">
            ...
            <li>• Small conversations turning into arguments</li>
            <li>• Feeling unheard or ignored</li>
            <li>• Difficulty expressing needs or emotions</li>
            <li>• Emotional disconnection</li>
            <li>• Avoidance or communication shutdown</li>
            <li>• Feeling like you’re talking… but not connecting</li>
          </ul>
        </div>
        ...
        >
          <Image
            src="/services/whoconnection2.png" 
