...
export default function CoachingHelp4() {
  const items = [
    "Trauma survivors",
    "Triggered or anxious individuals",
    "People healing abandonment wounds",
    "Anyone seeking emotional stability",
  ];

  // Parent stagger for clean reveal
